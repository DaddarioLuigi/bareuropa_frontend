...
export function HeroSection() {
  return (
    <section id="home" className="relative min-h-[100vh] sm:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-16 sm:py-20 pb-24 sm:pb-16">
        <div className="max-w-4xl mx-auto">
          <motion.h1
            className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-primary-foreground mb-4 sm:mb-6 text-balance leading-tight px-2 hidden sm:block"
          ...
          >
            <Link href="/products" className="w-full sm:w-auto">
              ...
              >
                <Button
                  size="lg"
                  className="bg-accent hover:bg-accent/90 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg w-full sm:w-auto min-h-[44px] sm:min-h-[48px]"
                >
